...
public class signupthree extends JFrame implements ActionListener {
    ...
    signupthree( String formno){
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-7654");
        ...
        c7 = new JCheckBox("I hearby declares that the above enter details are correct to the best of my knowledge ");
    ...
    public void actionPerformed(ActionEvent ae){
       if (ae.getSource()== submit) {
           ...
           if (r1.isSelected()){
               ...
               accoutType = "Fixed Deposite Account";
           } else if (r3.isSelected()) {
               accoutType ="Current Account";
           } else if (r4.isSelected()) {
            accoutType = "Recurring Deposite Accounnt";
           }
